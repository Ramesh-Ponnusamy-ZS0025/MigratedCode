...
def calculate_credit_score(customer_id):
    ...
    try:
        ...
        """)
        connection.execute(query, {"credit_score": round(credit_score, 0), "customer_id": customer_id})
        ...
        if credit_score < 500:
            ...
            """)
            connection.execute(query, {"customer_id": customer_id, "credit_score": round(credit_score, 0)})
